# Support for Output Descriptors in WinstarRxcoin Core

Since WinstarRxcoin Core v0.17, there is support for Output Descriptors. This is a
...
on WinstarRxcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing WinstarRxcoin Core wallets, a convenience function `combo` is
